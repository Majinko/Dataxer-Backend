...
@PreAuthorize("hasPermission(null, 'Overview', 'Overview')")
public class OverviewController {
    ...
    public ResponseEntity<List<UserHourOverviewDTO>> userHourStatisticForMonth(@RequestParam(value = "fromDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate fromDate, @RequestParam(value = "toDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate toDate) {
